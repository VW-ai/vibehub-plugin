 ...
 */
import type { MapSnapshot, ScopeDeclaration } from "@vibehub/core/contracts";
  ...
  territories: [
    {
      ...
      subBlocks: [],
      layout: { left: 3, top: 4.5, width: 45, height: 50 },
    },
    {
      id: "x-api",
      name: "Public API",
      ...
      subBlocks: [],
      layout: { left: 51, top: 4.5, width: 22, height: 30 },
    },
    {
      id: "x-auth",
      name: "Auth",
      ...
      subBlocks: [],
      layout: { left: 76, top: 4.5, width: 21, height: 30 },
    },
    {
      id: "x-billing",
      name: "Billing",
      ...
      subBlocks: [],
      layout: { left: 51, top: 37, width: 22, height: 26 },
    },
    {
      id: "x-search",
      name: "Search",
      ...
      subBlocks: [],
      layout: { left: 76, top: 37, width: 21, height: 26 },
    },
    {
      id: "x-mail",
      name: "Mail",
      ...
      subBlocks: [],
      layout: { left: 3, top: 57, width: 22, height: 35 },
    },
    {
      id: "x-jobs",
      ...
      subBlocks: [],
      layout: { left: 27, top: 57, width: 21, height: 35 },
    },
    {
      id: "x-infra",
      name: "Infra & Deploy",
      ...
      subBlocks: [],
      layout: { left: 51, top: 66, width: 22, height: 26 },
    },
    {
      id: "x-vendored",
      ...
      subBlocks: [],
      layout: { left: 76, top: 66, width: 21, height: 26 },
    },
  ],
  occupancy: [
    {
