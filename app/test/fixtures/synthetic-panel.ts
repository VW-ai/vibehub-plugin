/**
 * synthetic-panel — generate a MINIMAL TaskPanelSnapshot from a map Task for
 ...
 */
import type { Task, MapSnapshot } from "@vibehub/core/contracts";
import type { TaskPanelSnapshot, TimelineEvent } from "@vibehub/core/contracts";

export function syntheticPanel(task: Task, map: MapSnapshot): TaskPanelSnapshot {
