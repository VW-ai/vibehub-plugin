  ...
  territories: [
    {
      ...
      subBlocks: [],
      layout: { left: 3, top: 4.5, width: 27, height: 38 },
    },
    {
      id: "t-pay",
      ...
      layout: { left: 32.5, top: 4.5, width: 37, height: 55 },
    ...
    },
    {
      ...
      subBlocks: [],
      layout: { left: 3, top: 46.5, width: 27, height: 46 },
    },
    {
      id: "t-notify",
      name: "Notifications",
      anchoredFileCount: 9,
      subBlocks: [],
      layout: { left: 32.5, top: 63.5, width: 17.5, height: 29 },
    },
    {
      id: "t-ci",
      name: "Build & CI",
      ...
      subBlocks: [],
      layout: { left: 52, top: 63.5, width: 17.5, height: 29 },
    },
    {
      id: "t-fe",
      name: "Web UI",
      ...
      subBlocks: [],
      layout: { left: 72.5, top: 4.5, width: 24.5, height: 88 },
    },
  ],
  occupancy: [
    {
