...
- Use the on-demand Overview for compact counts and a two-axis legend only.
  Proposal/decision scaffolding and an empty Active-Run explanation do not
  belong in the production Overview.
