...
5. Read `ticket frontier` back. Only a successful Outcome unlocks direct
   ...
   follow-up gap. Presentation is not another approval step. A durable
   cross-ticket fact revealed by adjudication is delegated to
   `$vibehub-ingest`, placed in the Ticket's room. Do not create speculative
   parity work.
