...
if(packageIndex>=0){
  ...
  const skills=["vibehub-ingest","vibehub-query","vibehub-distill","vibehub-update","vibehub-review","vibehub-setup","vibehub-pr","vibehub-ticket-plan","vibehub-ticket-review","vibehub-ticket-validate"];
  ...
  if(fs.existsSync(operationArtifactPath)){
    ...
    const expectedConstructs={trim:0,transform:0,preprocess:0,pipe:0,default:0,catch:0,coerce:0,regex:9,isoDatetime:1,union:2,discriminatedUnion:5,unknown:1,strict:76,safeExtend:1,optional:94,nullable:10,check:1,custom:1,meta:1,overwrite:0,normalize:0,lowercase:0,uppercase:0,nonempty:0,length:0,any:0};
