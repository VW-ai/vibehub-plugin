...
if(packageIndex>=0){
  ...
  if(fs.existsSync(operationArtifactPath)){
    ...
    const expectedConstructs={trim:0,transform:0,preprocess:0,pipe:0,default:0,catch:0,coerce:0,regex:3,isoDatetime:1,union:1,discriminatedUnion:1,unknown:1,strict:54,safeExtend:1,optional:89,nullable:9,check:1,custom:1,meta:1,overwrite:0,normalize:0,lowercase:0,uppercase:0,nonempty:0,length:0,any:0};
