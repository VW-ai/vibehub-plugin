...
- [change-2026-07-18-codex-activation-parity] activation ⑥E:Codex parity——同一 SQLite/identity/setup primitives/evidence 定义 + progressive codex.md（capability matrix、双向诚实的 hooks 表述:官方已文档化但本 release 未验证不作证据）、打包与 clean-HOME artifact 断言、缺 codex.md 结构性 fail；真实 Codex host dogfood 保留 pending；027 前提过时事实已记录待晨审；独立 review APPROVED
