/**
 * Merge-friendly v2 architecture candidate.
 *
 * Still experimental: no package-root export and no runtime/App/MCP wiring.
 * It adapts the proven v1 round-trip protocol into stable identity paths,
 * collision-safe provenance identities, ref reads, and commit-keyed caches.
 */
