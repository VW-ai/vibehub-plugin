 ...
 */
export type TimelineEvent = LaunchEvent | SelfReportEvent | FileChangeEvent | FileReadEvent | TestRunEvent | UserInjectionEvent | UserInterventionEvent | AgentAckEvent | QuestionEvent | CrossReadNoticeEvent | CommitEvent | StateTransitionEvent;
/**
