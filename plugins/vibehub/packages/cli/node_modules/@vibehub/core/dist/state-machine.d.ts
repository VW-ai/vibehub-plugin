...
export type HookEventName = "SessionStart" | "UserPromptSubmit" | "PostToolUse" | "Notification" | "Stop" | "SessionEnd" | "SubagentStart" | "SubagentStop" | "PostToolUseFailure" | "StopFailure";
export declare function nextState(current: TaskState, hook: HookEventName): TaskState;
