    ...
    case "user_injection":
      return (
        <div
          ...
          data-tip={
            e.mode === "inject"
              ? "Your mid-flight injection — delivered at the agent's next turn boundary, no interruption. Interventions are part of the history."
              : "Your message, delivered after stopping the agent. Interventions are part of the history."
          }
        >
          <div className="who">
            {e.mode === "inject" ? "You · injected, no interrupt" : "You · paused & instructed"}
          </div>
          &ldquo;{e.text}&rdquo;
        </div>
      );
