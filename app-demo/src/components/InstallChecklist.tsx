 ...
 * rendered PURELY from InstallStep[] (fixture data via install-types).
 * Ported from static/empty-install-s2.html: circle = pending, check = done,
 ...
 * truth (label, status, failure) all comes from the fixture. Unknown step
...
export interface InstallChecklistProps {
  steps: InstallStep[];
  /** Retry the failed step (demo path: rerun + complete). Absent = no retry UI action wired (pristine checklist). */
