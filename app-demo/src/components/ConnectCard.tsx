 ...
 */
import type { RepoConnectionConnecting, RepoConnectionNone, InstallStep } from "../install-types";
import { PRISTINE_INSTALL_STEPS } from "../fixtures/install-first-run";
...
export interface ConnectCardProps {
  ...
  /** Demo-run step statuses overriding the fixture's (CTA / Retry path). */
