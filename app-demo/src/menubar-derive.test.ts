/**
 * menubar-derive rollup tests (m5, S3 gate) — the pure MapFixture →
...
import { BADGE_CAP, MAX_NEEDS_YOU_ROWS, deriveMenubar, deskClock } from "./menubar-derive";
import {
  menubarFixtures,
  menubarFlood,
  menubarOverload,
...
function fixture(partial: Partial<MapFixture>): MapFixture {
  return {
    capturedAt: CAP,
