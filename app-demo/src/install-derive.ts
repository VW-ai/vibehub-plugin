 ...
 * demoed in the `two-tasks` variant; DECISIONS-NEEDED fork "Pre-mapping
 ...
 */
import type { UncategorizedFootprint } from "./install-types";
...
/**
 * Defaults measured from static/empty-install-s2.html: the S1/S2 N=1 block
 ...
 * pass (same caveat as DemoLayout in types.ts).
 */
