...
import { validateGitWorktreeObservation, GIT_SENSOR_LIMITS } from '../src/core/git-worktree-observation.mjs';
import { observeGitWorktree } from '../src/adapters/git-worktree-observer.mjs';
