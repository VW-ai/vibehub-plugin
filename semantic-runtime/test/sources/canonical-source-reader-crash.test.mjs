...
import { readerFixture, makeReader, READER_ACTIONS } from '../support/canonical-reader-fixture.mjs';
import { rows } from '../support/graph-store-fixture.mjs';
...
async function crashAt(t, f, phase) {
  ...
  const child = spawn(process.execPath, [new URL('../support/canonical-reader-process.mjs', import.meta.url).pathname,
