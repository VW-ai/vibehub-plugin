...
import { sensorFixture, git, SENSOR_ACTIONS, SENSOR_SCOPE } from '../support/git-sensor-fixture.mjs';
...
test('actual index/config/HEAD FIFOs fail promptly without intake or scratch leaks', t => {
  ...
  const script = `
    ...
    import { join } from 'node:path';
    import { tmpdir } from 'node:os';
    import { sensorFixture } from ${JSON.stringify(new URL('../support/git-sensor-fixture.mjs', import.meta.url).href)};
    const results = [];
