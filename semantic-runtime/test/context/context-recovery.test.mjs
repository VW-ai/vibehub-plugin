...
import { fixture, contextRequest, publish, adoption, rows } from '../support/context-fixture.mjs';
...
function launch(t, f, mode, method, request, name) {
  ...
  const child = spawn(process.execPath, [new URL('../support/exploration-process.mjs', import.meta.url).pathname,
