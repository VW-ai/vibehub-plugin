...
import { contextJudgeFixture, judgeTransport, judgeResponse, publish, rows, CONTEXT_JUDGE_ACTIONS } from '../support/context-judge-fixture.mjs';
import { bindRequest, git, pin } from '../support/exploration-fixture.mjs';
...
for (const direction of ['typed-first', 'legacy-first']) test(`${direction}: shared in-flight identity prevents a second cross-profile dispatch`, async t => {
  ...
  const request = (await import('../support/context-fixture.mjs')).contextRequest(f, f.a, 'mixed-legacy');
