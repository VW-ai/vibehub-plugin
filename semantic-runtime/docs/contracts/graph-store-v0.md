...
[SQLite measurement](../../verification/reports/graph/graph-store-sqlite-20260922.json) exercises
...
The [2026-09-22 live run](../../verification/reports/graph/jev-graph-round-trip-20260922.json) completed
...
The [source-closure follow-up](../../verification/reports/graph/jev-graph-source-closure-20260922.json)
...
The [live source-fence run](../../verification/reports/sources/jev-inflight-source-fence-20260922.json)
...
The [final invalidation composition run](../../verification/reports/support/jev-invalidation-composition-final-20260922.json)
...
The [canonical-reader Graph regression](../../verification/reports/graph/jev-canonical-graph-regression-20260922.json)
