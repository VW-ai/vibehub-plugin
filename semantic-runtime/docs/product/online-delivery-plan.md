...
[Tech Design](../architecture/03_tech_design_semantic_runtime.md) remain unchanged proposed drafts.
...
pending. [Run instructions and boundaries](../operations/local-service-profile.md).
...
synthetic smoke succeeds. [Adapter contract and smoke](../contracts/openrouter-jev-adapter.md).
...
The [domain store](../contracts/domain-store-v0.md) now supplies scoped durable CAS/source/outbox
transactions. The [Git registry](../contracts/git-project-enrollment-v0.md) enrolls selected
...
The [Project activation module](../contracts/project-activation-v0.md) now persists explicit
...
[selected canonical-record reader](../contracts/canonical-source-reader-v0.md). The reader's
...
The [local exploration projection](../contracts/exploration-projection-v0.md) now binds real
...
The [selected Judge invocation](../contracts/judge-runtime-v0.md) now composes exact local
...
[Primary interface research and local observations](../architecture/local-app-integration-notes.md)
